...
<head>
	...
	<style>
		.searchTerm {
			width: 60% !important;
			border: 3px solid #806845 !important;
		...
		.searchButton {
			width: 25% !important;
			height: 30px !important;
			border: 1px solid #BF9C67 !important;
			background: #806845 !important;
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			...
			<form class="form-inline" action="search" method="get">
				<input type="text" class="form-control mb-2 mr-sm-2 searchTerm" name="key" placeholder="Enter keyword">
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdown04">
							...
							<a class="dropdown-item" href="{{url('type/Male')}}">Men's Shoes</a>
							<a class="dropdown-item" href="{{url('type/Famale')}}">Women's Shoes</a>
						</div>
					</li>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4 ml-md-5">
						...
						<ul class="list-unstyled">
							...
							<li><a href="{{url('index')}}" class="py-2 d-block">Journal</a></li>
