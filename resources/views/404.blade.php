...
<head>
  <meta charset="UTF-8">
  <title>Lost in Space 404 Error Page with SVG & CSS Animation</title>
  <base href="{{asset('')}}">
  ...
  <body class="permission_denied">
    ...
    <div class="denied__wrapper">
      ...
      <svg id="astronaut" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <g>
          <path d="M307.6 397.2h4.6c2.6 0 5.1-2.3 5-5-.1-2.7-2.2-5-5-5h-4.6c-2.6 0-5.1 2.3-5 5 .1 2.7 2.2 5 5 5z"
            class="st1" />
        </g>
        <g>
          <path d="M199.2 397.2h4.6c2.6 0 5.1-2.3 5-5-.1-2.7-2.2-5-5-5h-4.6c-2.6 0-5.1 2.3-5 5 .1 2.7 2.2 5 5 5z"
            class="st1" />
        </g>
        <g class="st10">
          <path
      ...
      <a href="index"><button class="denied__link">Go Home</button></a>
    </div>
    <!-- partial -->
