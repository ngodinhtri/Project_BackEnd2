    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                ...
                <h1 class="mb-0 bread">{{$products_type[0]->name_type}}</h1>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="col text-center">
                        <div class="block-27">
                            <ul>
                                ...
                                <li><a href="type/{{$type_page}}?page={{$previous_page}}">&lt;</a></li>
                                {{-- Vòng Lặp Nút Trang --}}
                                @for($i = 1; $i <= $total_page; $i++) <!--nếu là trang hiện tại-->
                                    @if ($i == $page_now)
                                    <li class="active"><a href="type/{{$type_page}}?page={{$i}}">{{$i}}</a></li>
                                    @else
                                    <li><a href="type/{{$type_page}}?page={{$i}}">{{$i}}</a></li>
                                    @endif
                                    @endfor

                                    <li><a href="type/{{$type_page}}?page={{$next_page}}">&gt;</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
